...
BACKGROUND = "#000000"
COLOR_SCORE = ["red", "yellow", "blue", "green", "orange", "pink", "purple", "brown", "grey"]
CHENG_COLOR_SCORE = 0
CHENG_COLOR_FOOD = 0
...
def next_turn(snake, food):
    ...
    if x == food.coordinates[0] and y == food.coordinates[1]:
        ...
        label.config(text="Round:{}[Score:{}]".format(round, score), bg=COLOR_SCORE[CHENG_COLOR_SCORE])
        if CHENG_COLOR_SCORE == 8:
            CHENG_COLOR_SCORE = 0
        else:
            CHENG_COLOR_SCORE += 1
        canvas.delete("food")
...
label = Label(window, text="Round:{}[Score:{}]".format(round, score), bg="grey", font=('consolas', 40))
label.pack()
